...
public class TestLand {
	...
	public void testSave() {
		...
		landInfo.setReportType(NormalConstant.LAND_ESTATE);
		landInfo.setProjectName("房地产一期评估");
		landInfo.setAssessReportNum("(江苏) 天征XXX估第00000013");
	...
	@Test
	public void testGet() {
		System.out.println(indexService.getDetailReport(13, NormalConstant.LAND_ESTATE));
	}

	@Test
	public void testDelete() {
		System.out.println(indexService.deleteEstateData(14, NormalConstant.LAND_ESTATE));
	}
}
